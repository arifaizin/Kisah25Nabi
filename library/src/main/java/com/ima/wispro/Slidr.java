...
import com.ima.wispro.model.SlidrInterface;
import com.ima.wispro.widget.SliderPanel;
...
public class Slidr {
     ...
     * @return              a {@link com.ima.wispro.model.SlidrInterface} that allows
    ...
    /**
     * Attach a slider mechanism to an activity based on the passed {@link com.ima.wispro.model.SlidrConfig}
     *
     * @param activity      the activity to attach the slider to
